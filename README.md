...
- `web_search` - Search the web, retrieve retained results, and inspect provider capabilities. Requires Search API access, rechecked on every request. Search creation is billable and is not automatically retried.
